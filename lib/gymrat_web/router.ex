defmodule GymratWeb.Router do
  ...
  scope "/", GymratWeb do
    ...
    live_session :require_authenticated_user,
      ...
      live "/plans/:plan_id/workouts/:workout_id/exercises/new/custom",
           ExerciseLive.AddCustom,
           :new_custom_exercise

      live "/plans/:plan_id/workouts/:workout_id/exercises/:exercise_id/edit",
           ExerciseLive.Edit,
           :edit_exercise
      ...
      live "/scoreboard", ScoreboardLive.VolumeScoreboard, :volume_scoreboard
