...
Gymrat is a Phoenix 1.8 / LiveView fitness-tracking app (workout plans, exercises, sets, weight tracking, leaderboards). Deployed as a Docker image built and pushed to GHCR (see `.github/workflows/deploy.yml`); rollout is GitOps via ArgoCD in a homelab cluster.
